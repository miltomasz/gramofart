package com.soldiersofmobile.components;
 ...
 * types of drawable are set as the image source, the corners <b>will not be
 * rounded.</b>
 * 
 * @author alex
 * 
...
public class RoundedImageView extends ImageView {
	...
	/**
	 * Sets the corner radius for rounded image corners in absolutely display
	 * pixels.
	 * 
	 * @param cornerRadius
	 */
